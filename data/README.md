...
## `emulated_training.jsonl`

Locally generated bi-encoder examples covering the complete catalog and the
released public-session profiles. See `../docs/dense_training.md` and regenerate it
from the repository root with `python dense/generate_emulated_training.py`.
